...
$(function() {
    ...
    */
    describe('RSS Feeds', function() {
        ...
        //in the allFeeds object and it ensures it has a name defined
         //and that the name property is not empty.
    ...
    //  a new test suite "The menu"
     describe('The menu', function(){
        ...
        // It ensures the menu element is hidden by default. 
            ...
            // a test to ensures the menu changes
          //visible when the menu icon is clicked and hidde when its clicked again
